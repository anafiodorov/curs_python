...
class Fractie(object):
    ...
    def add(self, other):
        ...
        return f"Rezultatul adunarii este : {numarator_final}/{numitor_final} "
    ...
    def subtract(self, other):
        ...
        numarator_final = int(numarator / cmmdc)
        numitor_final = int(numitor / cmmdc)
        return f"Rezultatul scaderii este : {numarator_final}/{numitor_final} "
    def inverse(other):
        numaratorul_nou = other.numitor
        numitorul_nou = other.numarator
        return f"Inversul este : {numaratorul_nou}/{numitorul_nou} "
f_1 = Fractie(2, 4)
f_2 = Fractie(5, 2)
